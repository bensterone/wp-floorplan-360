...
// Use the standard WordPress Loop so get_the_ID() and template tags always
// return correct values, regardless of when template_include fires relative
// to the main query setup.
while ( have_posts() ) :
    the_post();
